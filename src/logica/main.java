...
public class main {
    ...
    public static void main(String args[]){
        ...
        CuracionEstados.put("Antihielo 8£", new CuracionEstados("Antihielo",8,"Medicina en espray que descongela a un Pokémon."));
        CuracionEstados.put("Antiparalizador 200£", new CuracionEstados("Antiparalizador",200,"Medicina en espray que cura a un Pokémon paralizado."));
        CuracionEstados.put("Antiquemar 40 £", new CuracionEstados("Antiquemar",40,"Medicina en espray que cura las quemaduras a un Pokémon."));
        CuracionEstados.put("Antídoto 20£",new CuracionEstados("Antídoto",20,"Medicina en espray que contrarresta los efectos del veneno en un Pokémon."));
        CuracionEstados.put("Antí-Covid19 100£", new CuracionEstados("Antí-Covid19",100,"Te quita el covi"));
        CuracionEstados.put("Galleta Lava 25£", new CuracionEstados("Galleta Lava",25,"Dulce típico de Pueblo Lavacalda que cura todos los problemas de estado de un Pokémon."));
        CuracionEstados.put("Galleta Yantra 30£", new CuracionEstados("Galleta Yantra",30,"Especialidad de Ciudad Yantra. Cura los problemas de estado de un Pokémon."));
        CuracionEstados.put("Hierba Mental 67£", new CuracionEstados("Hierba Mental",67,"El Pokémon que la lleva se libera del enamoramiento. Solo puede usarse una vez."));
        CuracionEstados.put("Polvo curación 44£", new CuracionEstados("Polvo Curación",44,"Polvos medicinales muy amargos que curan todos los problemas de estado de un Pokémon.") );
        CuracionEstados.put("Porcehelado 32£", new CuracionEstados("Porcehelado",32,"Especialidad de Ciudad Porcelana. Cura los problemas de estado de un Pokémon.") );
        CuracionEstados.put("Refresco 15£", new CuracionEstados("Refresco",15,"Chispeante bebida gaseosa que restaura 60 PS de un Pokémon.") );
        CuracionEstados.put("Restaurar Todo 100£", new CuracionEstados("Restaurar Todo",100,"Medicina que restaura todos los PS y cura todos los problemas de estado de un Pokémon."));
                    ...
                    switch (escogerProducto){
                        case 1:
                            ...
                            switch (escogerBotiquin){
                                case 1:
                                    for (String key : CuracionEstados.keySet()) {
                                        System.out.println(i + ". " + key);
                                        i++;
                                    }
                                    //imprimirProductoEscogido();
                                case 2:
                                    for (String key : RecuperarVitalidad.keySet()) {
                                        System.out.println(i + ". " + key);
                                        i++;
                                    }
                                    //imprimirProductoEscogido();
                        ...
                        case 6:
                            for (String key : Evolution.keySet()) {
                                System.out.println(i + ". " + key);
                                i++;
                                //imprimirProductoEscogido()
                            }
        ...
        public static int leerNumero(){
            ...
            String entrada;
            while (true){
                System.out.println("Ingresa la opción correspondiente:");
                entrada = lector.nextLine();
                int valorAscii = (int)entrada.charAt(0);
                if ( 48 <= valorAscii  && valorAscii <= 57){
        ...
        public static int preguntarProducto(){
            Scanner lector = new Scanner(System.in);
            String entrada;
            while (true){
        ...
        public static String imprimirProductoEscogido(){
            int k = preguntarProducto();
            return "aa";
