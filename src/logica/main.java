...
public class main {
    public static void main(String args[]){
        ...
        CuracionEstados c11 = new CuracionEstados("Refresco",15,"Chispeante bebida gaseosa que restaura 60 PS de un Pokémon.");
        ...
        CuracionEstados.put("Antídoto",c4 ); CuracionEstados.put("Antí-Covid19", c5 ); CuracionEstados.put("Galleta Lava", c6);
        CuracionEstados.put("Galleta Yantra", c7); CuracionEstados.put("Hierba Mental", c8 ); CuracionEstados.put("Polvo curación", c9 );
        ...
        RecuperarVitalidad.put("Agua Fresca", r7); RecuperarVitalidad.put("Hiperpoción", r8); RecuperarVitalidad.put("Raíz Energía", r9);
        ...
        Obj_clave cl7 = new Obj_clave("Planta Bayas",44,"Dispositivo portátil de cultivo que permite plantar Bayas en cualquier momento de forma sencilla.");
        ...
        PokeBall.put("Ultra Ball", k1); PokeBall.put("Super Ball", k2); PokeBall.put("Poké Ball", k3);
        PokeBall.put("Máster Ball", k4); PokeBall.put("Honor Ball", k5);  PokeBall.put("Lujo Ball", k6);
        ...
        Evolution e3 = new Evolution("Disco Extraño",12,"Dispositivo transparente que contiene datos misteriosos. Es de fabricante desconocido.");
        ...
        Evolution e8 = new Evolution("Revestimiento Metálico",86,"Película metálica que fortalece los ataques de tipo Acero. Debe llevarlo un Pokémon.");
        ...
        Evolution.put("Colmillo Agudo", e1); Evolution.put("Diente Marino", e2); Evolution.put("Disco Extraño", e3); Evolution.put("Escama Marina", e4);
        Evolution.put("Piedra Alba", e5);  Evolution.put("Piedra Solar", e6); Evolution.put("Protector", e7); Evolution.put("Revestimiento Metálico", e8);
